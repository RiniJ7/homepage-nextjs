...
//define the types of card props 
interface CardProps {
...
//define cards component to render individual card items
const Cards = ( { backgroundImage, title, subTitle, peopleJoined }: CardProps) => {

  return (
    // card container with dynamic background image
...
/>
  ...
  {/* displaying people's images and count */}
<div className="flexCenter gap-6">
<span className="flex -space-x-4 overflow-hidden">
{/* Mapping through PEOPLE_URL array to render people's images */}
{ PEOPLE_URL.map((url) => (
  <Image
...
{/* displaying number of people joined */}
...
const Card = () => {
  return (
    //section container for cards and overlay texts
